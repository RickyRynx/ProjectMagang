...
public class AbsensiKeluarManagerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etNama = findViewById(R.id.etNamaManager);
        etJabatan = findViewById(R.id.etJbtManager);
        etTanggal = findViewById(R.id.etTglManager);
        btnAbsenOut = findViewById(R.id.btnAbsenKeluarManager);
