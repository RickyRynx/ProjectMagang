...
public class AbsensiMasukManagerActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnUpload = findViewById(R.id.btnCaptureManager);
        btnAbsen = findViewById(R.id.btnAbsenManager);
        ...
        etTanggal.setOnClickListener(View -> {
            new DatePickerDialog(AbsensiMasukManagerActivity.this, date, myCalendar.get(Calendar.YEAR), myCalendar.get(Calendar.MONTH), myCalendar.get(Calendar.DAY_OF_MONTH)).show();
        });
