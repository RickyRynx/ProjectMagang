...
public class CutiManagerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCuti.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                NotificationCompat.Builder builder = new NotificationCompat.Builder(CutiManagerActivity.this, "notification");
                builder.setContentTitle("Pengajuan Cuti");
                builder.setContentText("Pengajuan Cuti Berhasil!!.");
                builder.setSmallIcon(R.drawable.ic_notification);
                builder.setAutoCancel(true);

                NotificationManagerCompat managerCompat = NotificationManagerCompat.from(CutiManagerActivity.this);
                if (ActivityCompat.checkSelfPermission(CutiManagerActivity.this, android.Manifest.permission.POST_NOTIFICATIONS) != PackageManager.PERMISSION_GRANTED) {
        ...
        etMulai.setOnClickListener(View -> {
            new DatePickerDialog(CutiManagerActivity.this, dateMulai, calendarMulai.get(Calendar.YEAR), calendarMulai.get(Calendar.MONTH), calendarMulai.get(Calendar.DAY_OF_MONTH)).show();
        });

        etSelesai.setOnClickListener(View -> {
            new DatePickerDialog(CutiManagerActivity.this, dateSelesai, calendarSelesai.get(Calendar.YEAR), calendarSelesai.get(Calendar.MONTH), calendarSelesai.get(Calendar.DAY_OF_MONTH)).show();
        });
    }
    ...
    private void pengajuanCuti(String nama, String jabatan, String keterangan, String mulai, String selesai) {
        ...
        reference = database.getReference("TabelPengajuanCutiManager");
        ...
        reference.child(postId).setValue(map).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    Intent intent = new Intent(CutiManagerActivity.this, DashManagerActivity.class);
                    Toast.makeText(CutiManagerActivity.this, "Pengajuan Cuti Berhasil", Toast.LENGTH_SHORT).show();
