...
public class FaceIdActivity extends CameraActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnVerif.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                NotificationManagerCompat managerCompat = NotificationManagerCompat.from(FaceIdActivity.this);
                if (ActivityCompat.checkSelfPermission(FaceIdActivity.this, android.Manifest.permission.POST_NOTIFICATIONS) != PackageManager.PERMISSION_GRANTED) {
                ...
                if (task.isSuccessful()) {
                    photoRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(FaceIdActivity.this, "Gagal mendapatkan URL foto", Toast.LENGTH_SHORT).show();
                        }
                    });
                } else {
                    Toast.makeText(FaceIdActivity.this, "Gagal mengunggah foto", Toast.LENGTH_SHORT).show();
                }
